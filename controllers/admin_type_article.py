...
def valid_add_type_article():
    ...
    mycursor = get_db().cursor()
    sql = '''INSERT INTO type_cle_usb (libelle_type_cle_usb) VALUES (%s)'''
...
def delete_type_article():
    ...
    mycursor = get_db().cursor()
    sql = '''DELETE FROM type_cle_usb WHERE id_type_cle_usb = %s'''
...
def edit_type_article():
    id_type_article = request.args.get('id_type_article', '')
    mycursor = get_db().cursor()
    sql = '''SELECT * FROM type_cle_usb WHERE id_type_cle_usb = %s'''
    mycursor.execute(sql, (id_type_article,))
...
def valid_edit_type_article():
    ...
    mycursor = get_db().cursor()
    sql = '''UPDATE type_cle_usb SET libelle_type_cle_usb = %s WHERE id_type_cle_usb = %s'''
